...
namespace m5avatar
{
  ...
  class Girl2Eye : public Drawable
  {
  ...
  public:
    Girl2Eye(uint16_t r, bool isLeft)
        : r{r}, isLeft{isLeft} {}
  ...
  class Girl2Eyeblow : public Drawable
  {
  ...
  public:
    Girl2Eyeblow(uint16_t w, uint16_t h, bool isLeft)
  ...
  class Girl2Mouth : public Drawable
  {
  private:
    uint16_t minWidth;
    uint16_t maxWidth;
  ...
  public:
    Girl2Mouth() : Girl2Mouth(0, 0, 0, 0) {}
    Girl2Mouth(uint16_t minWidth, uint16_t maxWidth, uint16_t minHeight,
            uint16_t maxHeight)
        : minWidth{minWidth},
          maxWidth{maxWidth},
          minHeight{minHeight},
  ...
  /**
   * Faceクラスを継承したGirl2顔描画用のクラス
  */
  class Girl2Face : public Face
  {
  public:
    Girl2Face()
        : Face(new Girl2Mouth(50, 90, 4, 60), new BoundingRect(148, 163),
              new Girl2Eye(8, false),         new BoundingRect(93, 90),
              new Girl2Eye(8, true),          new BoundingRect(96, 230),
              new Girl2Eyeblow(32, 0, false), new BoundingRect(67, 96),
              new Girl2Eyeblow(32, 0, true),  new BoundingRect(72, 230)) {}
  };
